...
let butonContainer = document.querySelector(".btn-container")
...
function addButton() {
  ...
  butonContainer.innerHTML = createButton("All") + " " + createButton("Korea") + " " + createButton("Japan") + " " + createButton("China")
